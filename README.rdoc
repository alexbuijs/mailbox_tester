...
- retrieve yesterdays in messages from the prd environment and use it to make a soap call to the webservice on the acc environment
...
Add this line to /etc/crontab:
  0 0 * * * cvzprj /home/cvzprj/mailbox_tester/current/lib/process_messages.cron